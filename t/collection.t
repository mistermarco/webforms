...
use lib '../includes';
use_ok('FB::Form::Collection');

my $object = FB::Form::Collection->new();

print "Collection has...\n";
is(
    $object->isa("FB::Form::Collection"), 
    1,
    "...right class"
);
...
foreach my $property (@properties) {
    is(
        $object->$property,
        FB::Form::Collection->defaults($property),
...
is(
    $object->type,
    FB::Form::Collection->defaults('type'),

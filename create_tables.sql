...
# Database: fb
# Generation Time: 2009-08-28 22:27:22 -0700
# ************************************************************
...
) ENGINE=MyISAM AUTO_INCREMENT=19544 DEFAULT CHARSET=latin1;
...
CREATE TABLE `item` (
  ...
  `sort_order` int(11) unsigned DEFAULT NULL,
  PRIMARY KEY (`item_id`)
) ENGINE=MyISAM AUTO_INCREMENT=30863 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=4805 DEFAULT CHARSET=latin1;
...
CREATE TABLE `node` (
  ...
  PRIMARY KEY (`node_id`)
) ENGINE=MyISAM AUTO_INCREMENT=27888 DEFAULT CHARSET=latin1;
